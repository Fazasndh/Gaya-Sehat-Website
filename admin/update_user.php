...
<header>
    <nav class="container">
        ...
        <ul>
            ...
            <li><a href="about.php" class="<?php if($currentPage == 'about.php') { echo 'active'; } ?>">Tentang Kami</a></li>
            
            <?php if (isset($_SESSION['user_id'])): ?>
                <li><a href="bmi_calculator.php" class="<?php if($currentPage == 'bmi_calculator.php') { echo 'active'; } ?>">Kalkulator BMI</a></li>
                
                <li><a href="profile.php" class="<?php if($currentPage == 'profile.php') { echo 'active'; } ?>">Profil</a></li>
                <li><a href="logout.php">Logout</a></li>
            <?php else: ?>
                <li><a href="login.php" class="<?php if($currentPage == 'login.php') { echo 'active'; } ?>">Login</a></li>
                <li><a href="register.php" class="btn <?php if($currentPage == 'register.php') { echo 'active'; } ?>">Register</a></li>
            <?php endif; ?>
        </ul>
    </nav>
</header>